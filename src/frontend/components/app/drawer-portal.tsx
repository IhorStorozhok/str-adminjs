...
import { Drawer, DEFAULT_DRAWER_WIDTH } from '@storozhok/adminjs-design-system'
// @ts-ignore Note: Ignore while @storozhok/adminjs-design-system/styled-components doesn't export types
